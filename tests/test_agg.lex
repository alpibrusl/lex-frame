...
fn run_all() -> () {
  let _ := test_count_all() + test_count_non_null() + test_sum_col_int() +
            test_sum_col_float() + test_mean_col_int() + test_min_col_int() +
            test_max_col_int() + test_min_col_float() + test_max_col_float() +
            test_n_distinct_with_null() + test_n_distinct_float() +
            test_count_all_float() + test_count_non_null_no_nulls()
  ()
}
