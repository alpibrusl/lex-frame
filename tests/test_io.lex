...
fn run_all() -> Int {
  test_parse_csv_nrows() +
  test_parse_csv_ncols() +
  test_parse_csv_type_int() +
  test_parse_csv_empty_body_is_error() +
  test_render_csv_nonempty() +
  test_render_csv_roundtrip_nrows() +
  test_render_csv_roundtrip_ncols() +
  test_render_json_rows_nonempty() +
  test_render_json_rows_starts_with_bracket()
}
