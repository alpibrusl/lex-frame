...
fn run_all() -> () {
  let _ := test_select_cols_ncols() + test_select_cols_preserves_nrows() +
            test_select_unknown_col_is_error() + test_drop_cols_ncols() +
            test_rename_col_ncols() + test_rename_col_nrows() +
            test_rename_unknown_col_is_error() + test_filter_rows_nrows() +
            test_filter_rows_keeps_ncols() + test_with_column_ncols()
  ()
}
